...
cli.version = function() {
  ...
  if (fis.util.isWin()) {
    ...
    logo= [
      '__'+'8888888888'.bold.red+'___'+'Y88b'.bold.yellow+"_____" +'d88P'.bold.yellow+ '___'+'8888888b.'.bold.green,
      '__'+'888'.bold.red+'___________'+'Y88b'.bold.yellow+'__'+ 'd88P'.bold.yellow  +'_____'+'888'.bold.green +'____'+ 'Y88b'.bold.green ,
      '__'+'888'.bold.red+'____________'+'Y88o88P'.bold.yellow+'_______'+ '888'.bold.green+'_____'+'888'.bold.green,
      '__'+'8888888'.bold.red+'_________'+'Y888P'.bold.yellow+'________'+'888'.bold.green+ '_____'+   '888'.bold.green,
      '__'+'888'.bold.red+'_____________'+'d888b'.bold.yellow+'________'+  '888'.bold.green+'_____' +   '888'.bold.green,
      '__'+'888'.bold.red+'____________'+'d88888b'.bold.yellow+'_______'+'888'.bold.green+'_____'+'888'.bold.green,
      '__'+'888'.bold.red+'___________'+ 'd88P'.bold.yellow+'_'+ 'Y88b'.bold.yellow +'______'+ '888'.bold.green+'___'+  '.d88P'.bold.green,
      '__'+'888'.bold.red+'__________' +'d88P'.bold.yellow+'___'+'Y88b'.bold.yellow+'_____'+ '8888888P'.bold.green
    ].join('\n');
  } else {
    logo = [
      '   /\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\  /\\\\\\\\\\\\\\\\\\\\\\     /\\\\\\\\\\\\\\\\\\\\\\   ',
